...
/**
 * The /companies/<COMPANY-ID>/addrs endpoint. Implements the following endpoints:
 *
 *     GET    https://<BASE-URL>/api/companies/<COMPANY-ID>/addrs
 *     GET    https://<BASE-URL>/api/companies/<COMPANY-ID>/addrs/<ADDRESS-ID>
 *     POST   https://<BASE-URL>/api/companies/<COMPANY-ID>/addrs
 *     PUT    https://<BASE-URL>/api/companies/<COMPANY-ID>/addrs/<ADDRESS-ID>
 *     DELETE https://<BASE-URL>/api/companies/<COMPANY-ID>/addrs/<ADDRESS-ID>
 *
