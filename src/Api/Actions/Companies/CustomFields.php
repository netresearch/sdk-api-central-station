...
use Netresearch\Sdk\CentralStation\Request\Companies\CustomFields\Index as IndexRequest;
use Netresearch\Sdk\CentralStation\Request\Companies\CustomFields\Show as ShowRequest;

/**
 * The /custom_fields endpoint. Implements the following endpoints:
 *
 *     GET    https://<BASE-URL>/api/companies/<COMPANY-ID>/custom_fields
 *     GET    https://<BASE-URL>/api/companies/<COMPANY-ID>/custom_fields/<CUSTOM-FIELDS-ID>
 *     POST   https://<BASE-URL>/api/companies/<COMPANY-ID>/custom_fields
 *     PUT    https://<BASE-URL>/api/companies/<COMPANY-ID>/custom_fields/<CUSTOM-FIELDS-ID>
 *     DELETE https://<BASE-URL>/api/companies/<COMPANY-ID>/custom_fields/<CUSTOM-FIELDS-ID>
 *
...
class CustomFields extends AbstractApiEndpoint
{
    ...
    public function show(ShowRequest $request): ?CustomField
    {
        ...
        return ($result instanceof CustomFieldContainer) ? ($result->customField ?? null) : null;
    }
