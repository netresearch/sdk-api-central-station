...
use Netresearch\Sdk\CentralStation\RequestBuilder\Companies\IndexRequestBuilder;
...
class IndexRequestBuilderTest extends RequestBuilderTestCase
{
    ...
    public function index(): void
    {
        ...
        self::assertSame(
            'perpage=10&page=2&order=name-desc&filter[name][like]=%Netresearch%&filter[created_at][smaller_than]=2022-10-25&includes=tags addrs&tag_name=TAG-NAME',
